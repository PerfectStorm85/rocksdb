...
ifneq ($(DEBUG_LEVEL), 2)
OPT += -O2 -flto -fno-omit-frame-pointer
...
BZIP2_DOWNLOAD_BASE ?= https://web.archive.org/web/20180624184756/http://www.bzip.org/
SNAPPY_VER ?= 1.1.4
...
libbz2.a:
	...
	cd bzip2-$(BZIP2_VER) && make CFLAGS='-fPIC -O2 -g -D_FILE_OFFSET_BITS=64 ${EXTRA_CFLAGS}' AR='$(AR) ${EXTRA_ARFLAGS}' libbz2.a
...
libsnappy.a:
	...
	cd snappy-$(SNAPPY_VER) && CFLAGS='${EXTRA_CFLAGS}' CXXFLAGS='${EXTRA_CXXFLAGS}' LDFLAGS='${EXTRA_LDFLAGS}' ./configure --with-pic --enable-static --disable-shared ${EXTRA_AMFLAGS}
...
liblz4.a:
	...
	cd lz4-$(LZ4_VER)/lib && make CFLAGS='-fPIC -O2 ${EXTRA_CFLAGS}' liblz4.a
...
libzstd.a:
	...
	cd zstd-$(ZSTD_VER)/lib && make CFLAGS='-fPIC -O2 ${EXTRA_CFLAGS}' libzstd.a
...
JAVA_STATIC_LDFLAGS = $(EXTRA_LDFLAGS)
